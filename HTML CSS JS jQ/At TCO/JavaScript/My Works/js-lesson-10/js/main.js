$(document).ready(function() {
	...
	function drawProducts(products) {
		...
		products.map(function(item, key) {
			$('#products').append('<div class="openModal" data-id="'+key+'"><div><img src="'+item.img+'" class="slick-cloned"/><a class="slider-item d-none" href="'+item.img+'" data-fancybox data-caption="'+item.name+ " (" + item.price + ")"+'"><img src="'+item.img+'" /></a>'
				+ '<div class="info"><p class="name">Name: <strong>'+ item.name+'</strong></p><p class="price">Price: <strong>'+item.price+'$</strong></p></div><div class="icons"><i class="fas fa-eye view-product" data-id="'+key+'"></i><i class="fas fa-edit edit-product" data-id="'+key+'"></i><i class="fas fa-trash-alt delete-product" data-id="'+key+'"></i></div></div></div>');
		});
	...
	$('.sortBy-change').change(function() {
		var val = $(this).val();

		if(val === 'price') {
			products.sort(function(second, first) {

                ...
                <form action="index.php" method="POST">
                    <div class="login-form clearfix">
                        <div class="email-input">
                            ...
                            <input type="text" class='<?= $errors['email']?>' name="email" id="email" placeholder="Enter Your E-mail" value='<?= $oldValue['email'] ?>'>
                        </div>
                        <div class="password-input">
                            <label for="password">Password</label>
                            <input type="password" class='<?= $errors['password']?>' name="password" id="password" placeholder="Enter Your Password">
                        </div>
    ...
    <main>
        ...
        <?php if($_SESSION['registered'] == true) :?>
            <div class="main-right-header">
                ...
                <form action="index.php" method ='post'>
                    <button type="submit" id="create_new_account" name="create_new_account">Create A New  Account</button>
                </form>
            </div>
        <?php else :?>
            <div class="main-right">
                ...
                <div class="signup-form">
                    <form action="index.php" method="POST">
                        <input type="text" class='<?= returnError('signup_firstname') ?>' id="signup_firstname"  name='signup_firstname' placeholder="First Name" value='<?=returnOldValue('signup_firstname')?>' >
                        <input type="text" class='<?= returnError('signup_lastname') ?>' id="signup_lastname" name='signup_lastname' placeholder="Last Name" value='<?=returnOldValue('signup_lastname')?>'>
                        <input type="text" id="signup_email" class='<?= $errors['signup_email']?>' name='signup_email' placeholder="E-mail" value='<?=$oldValue['signup_email'] ?>' >
                        <input type="password" class='<?= $errors['signup_password']?>' id="signup_password" name='signup_password' placeholder="Password">
                        <label for="signup_dirthday">Birthday</label> 
                        <input type="date" class='<?= returnError('signup_birthday') ?>' id="signup_dirthday" name='signup_birthday'  value='<?=returnOldValue('signup_birthday')?>'>
